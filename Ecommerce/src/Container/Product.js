...
import ListFoods from './ListProduct'
        ...
        return (
            ...
            <div className="container">
                ...
                <form className="col-10">
                    ...
                    <Button type="submit" color='danger' style={{width:500}} onClick={this.addFood} block>Add Product</Button>
                <br/>
                </form>
              <ListFoods />

              <Modal isOpen={this.state.modal}>
                <ModalHeader toggle={this.toggle}><legend>Add Category</legend></ModalHeader>
                <ModalBody>
                  <FormGroup>
